...
const MyProduct = () => {
  ...
  const [productTopBidderId, setProductTopBidderId] = useState(0);
  ...
  const fetchProduct = async () =>{
      await axios.get(`http://localhost:6001/fetch-product-details/${id}`).then(
          async(response)=>{
              ...
              setProductTopBidderId(response.data.topBidderId);
    ...
    return (
        ...
        {product ? 
            ...
            <div className="IndividualProduct-page">
                <span onClick={()=> navigate('/seller')}> <HiOutlineArrowSmLeft /> <p>back</p></span>
                    ...
                    <div className="IndividualProduct-data">
                        ...
                        {product.status === "Unsold" ?
                            <>
                                <h6><b>Start Price:</b>  	&#8377; {ProductStartPrice} </h6>
                                <div className="productBuyingButtons">
                                    <button className='btn btn-danger' disabled>Product unsold</button>
                                        <button onClick={()=> navigate(`/update-product/${id}`)}>Update</button>
                                </div>
                            </>
